...
public interface EisenhowerMatrix<T extends Comparable<T>> {
    ...
    /**
     * Retrieves the type of collections used within the quadrants.
     *
     ...
     * More specifically:
     * <ul>
     *     <li> Sorts tasks within each quadrant.
     *     <li>
     * </ul>
     *
     ...
     *
     * @param quadrantComparators a map of quadrants to their respective comparators.
     ...
     * @throws NullPointerException if {@code quadrantComparators} is {@code null}.
     */
